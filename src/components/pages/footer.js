...
const Footer = () => {
  return (
    <div className="bg_image_footer w-full lg:min-h-[30rem] flex justify-center items-center relative">
    <div className="container ">
      <div className="row justify-center md:mt-0 mt-12 pb-5  lg:ps-36 " >
      <div className="col-lg-4 col-sm-4 md:mb-0 mb-4 md:text-start text-center col-12 md:pt-0 pt-7">
      ...
      <div className="border_gold opacity-55 mt-5 ">
      </div>
